...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/firstcapui/firstcapui/test/integration/FirstJourney",
    "com/firstcapui/firstcapui/test/integration/BooksListJourney",
    "com/firstcapui/firstcapui/test/integration/BooksObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
